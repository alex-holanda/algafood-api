...
insert into restaurante (id, nome, taxa_frete, id_cozinha) values (1, 'Thai Gourmet', 10, 1);
insert into restaurante (id, nome, taxa_frete, id_cozinha) values (2, 'Thai Delivery', 9.50, 1);
insert into restaurante (id, nome, taxa_frete, id_cozinha) values (3, 'Tuk Tuk Comida Indiana', 15, 2);
